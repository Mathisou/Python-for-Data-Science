...
def display_truc(life_expectancy: pd.DataFrame, income_per_person: pd.DataFrame, year: str):
    """
    Display a scatter plot of life expectancy against income per person for a given year.
    """
